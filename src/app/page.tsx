      ...
      <section id="blog-section" class="max-w-7xl mx-auto w-full px-4 py-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <article class="bg-white rounded-3xl p-6 border border-slate-100 shadow-sm hover:shadow-md transition-all">
            ...
            <p class="text-slate-500 text-sm leading-relaxed text-justify">Định nghĩa lộ giới kiệt hẻm chuẩn, giải thích ưu nhược điểm thực tế và cách thẩm định giá khi tìm mua phân khúc nhà kiệt ô tô ở thực.</p>
          </article>
        </div>
      </section>
